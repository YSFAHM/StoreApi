...
namespace Store.Repository.Repositories
{
    public class GenericRepository<TEntity, TKey> : IGenericRepository<TEntity, TKey> where TEntity : BaseEntity<TKey>
    {
        ...
        public async Task<IReadOnlyList<TEntity>> GetAllWithSpecifcationAsync(ISpecification<TEntity> specs)
        {
            return await ApplySpecification(specs).ToListAsync();
        }

        public async Task<TEntity> GetWithSpecifcationByIdAsync(ISpecification<TEntity> specs)
        {
        ...
        {
            return SpecifcationEvaluator<TEntity, TKey>.GetQuery(_context.Set<TEntity>(), specs);
        }
